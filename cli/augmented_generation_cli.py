...
def main():
    ...
    cit_parser.add_argument("--limit", type=int, default=5, help="doc count to summarize w/ citations")
    ...
    question_parser.add_argument("--limit", type=int, default=5, help="doc count to answer questions with")
